...
public final class Stations {
 ...
 public static final List<Station> ALL=ordered(Arrays.asList(
  ...
  s("عمر القزابري","مصحف ورش عن نافع • تشغيل متواصل","Coran Warsh • lecture continue","Warsh Quran • continuous playback","","quran","https://server9.mp3quran.net/omar_warsh/001.mp3"),
  s("العيون الكوشي","مصحف ورش عن نافع • تشغيل متواصل","Coran Warsh • lecture continue","Warsh Quran • continuous playback","","quran","https://server11.mp3quran.net/koshi/001.mp3"),
  s("هشام الهراز","مصحف ورش عن نافع • تشغيل متواصل","Coran Warsh • lecture continue","Warsh Quran • continuous playback","","quran","https://server16.mp3quran.net/H-Lharraz/Rewayat-Warsh-A-n-Nafi/001.mp3"),
