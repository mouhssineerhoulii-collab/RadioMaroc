...
public final class Stations {
 ...
 public static final List<Station> ALL=Arrays.asList(
  ...
  s("Luxe Radio","لوكس راديو - ثقافة ونمط حياة","Culture et art de vivre","Culture and lifestyle",H+"images/logo-luxeradio.PNG","general","https://streaming.luxeradio.ma/luxeradio.mp3"),
  s("Radio Orient","راديو الشرق","Radio Orient","Radio Orient",G,"general","https://stream.rcs.revma.com/7hnrkawf4p8uv.mp3"),
  s("Radio Beur FM","بور إف إم","Beur FM","Beur FM",G,"general","https://broadcast.infomaniak.ch/beurfm-high.mp3"),
  ...
  s("Hit Radio Urban","هيت راديو أوربان","Hit Radio Urban","Hit Radio Urban",T,"music","https://urban.ice.infomaniak.ch/urban-128.mp3"),
  ...
  s("Hit Radio TikTok","هيت راديو تيك توك","Hit Radio TikTok","Hit Radio TikTok",T,"music","https://tiktok.ice.infomaniak.ch/tiktok-128.mp3"),
  ...
  s("Radio Planet House","راديو بلانيت هاوس","Radio Planet House","Radio Planet House",G,"music","https://stream.zeno.fm/9es1u4h6dkhvv"),
