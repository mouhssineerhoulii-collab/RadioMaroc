...
public final class Stations {
 ...
 public static final List<Station> ALL=ordered(Arrays.asList(
  ...
  s("Luxe Radio","لوكس راديو - ثقافة ونمط حياة","Culture et art de vivre","Culture and lifestyle",H+"images/logo-luxeradio.PNG","general","https://streaming.luxeradio.ma:8000/stream.mp3"),
